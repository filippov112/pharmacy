...
from ..pharmacy.views import index_view, error_access, reports_list, medicine_list, supplier_list, contract_list, \
    ...
    certificate_id, receipt_id, facility_id, doctor_id, physic_id, legal_id, order_id, prescription_id
